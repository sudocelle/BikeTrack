...
public final class ActivityMapBinding implements ViewBinding {
  ...
  private ActivityMapBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main,
      @NonNull MapView map, @NonNull Switch switch1, @NonNull TextView textView,
  ...
  public static ActivityMapBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMapBinding((ConstraintLayout) rootView, main, map, switch1, textView,
          textView4, textView6);
    }
