...
import com.testproject.biketrack.databinding.ActivityBikeBinding
...
class BikeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(binding.appBarBike.toolbar)

        binding.appBarBike.fab.setOnClickListener { view ->
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.bike, menu)
        return true
    }
